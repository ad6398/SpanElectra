...
##ad modify these dict as per your filename
...
class SpanElectraTokenizer(BertTokenizer):
    r"""
    Constructs an Electra tokenizer.
    :class:`~transformers.SpanElectraTokenizer` is identical to :class:`~transformers.BertTokenizer` and runs end-to-end
...
class SpanElectraTokenizerFast(BertTokenizerFast):
    r"""
    Constructs an Electra Fast tokenizer.
    :class:`~transformers.SpanElectraTokenizerFast` is identical to :class:`~transformers.BertTokenizerFast` and runs end-to-end
    tokenization: punctuation splitting + wordpiece.
